...
function apiHeart(e) {
  ...
  e.preventDefault();
  //  Action is there on the form tag
...
function typeAhead(search) {
    ...
    searchInput.on('keyup', function (e) {
        ...
        var currentActive = document.querySelector('.' + activeClass);
...
var _geoLocation = __webpack_require__(10);
...
(0, _geoLocation2.default)((0, _bling.$)('#address'), (0, _bling.$)('#lat'), (0, _bling.$)('#lng'));

// Search functionality
(0, _search2.default)((0, _bling.$)('.search'));
